...
** Code
Check out my [[https://github.com/paultsw][github page]].

** Writing
I have a blog with friendly explanations of algorithms, data structures, and basics of machine learning. You can find it here: [[https://algorithm.land][Algoland!]] Excuse the sparseness --- it's a permanent work-in-progress.
